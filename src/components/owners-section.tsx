...
export function OwnersSection() {
  return (
    <section className="owners-section ed-sec" id="intro" aria-labelledby="owners-heading">
      <div className="owners-section__copy">
        <p className="eyebrow">Your local furniture shop</p>
        <h2 id="owners-heading">Finbar and Eileen</h2>
        <p>
          Home Trends is a family-owned furniture showroom in Ennis, run by Finbar and Eileen
          Keaveney since 2013.
        </p>
