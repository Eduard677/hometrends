...
export const Route = createFileRoute("/bespoke")({ component: UpholsteryPage, head: () => pageHead({ title: "Upholstery | Home Trends Furniture", description: "See and feel physical fabric swatches in the showroom. Upholstery options at Home Trends Furniture, Ennis.", path: "/bespoke" }) });
