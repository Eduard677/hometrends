...
export const Route = createFileRoute("/returns")({ component: ReturnsPage, head: () => pageHead({ title: "Returns enquiries | Home Trends Furniture", description: "Have a question about an existing purchase? Returns enquiries for Home Trends Furniture, Ennis.", path: "/returns" }) });
