...
export const Route = createFileRoute("/showroom")({
  ...
  head: () => ({ meta: [{ title: "Visit our Ennis showroom | Home Trends Furniture" }, { name: "description", content: "Visit Home Trends Furniture at 29 Parnell Street, Ennis, V95 ED79. Mon–Sat 09:30–18:00. Directions, parking and telephone 065 679 7853." }] }),
});
